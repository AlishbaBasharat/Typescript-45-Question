...
const commonAnimals: string[] = ["Goat", "Dog", "Hen"];
for (let animals of commonAnimals) {
...
console.log(`what these animals have in common.These animals would make a great pet!`)
